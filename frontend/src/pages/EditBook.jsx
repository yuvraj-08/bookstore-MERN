...
const EditBook = () => {
  ...
  useEffect(()=>{
    setLoading(true);
    axios.get(`https://3000-yuvraj08-bookstoremern-sjc3k4uq8kx.ws-us114.gitpod.io/books/${id}`)
    .then((response) => {
  ...
  const handleEditBook = () => {
    ...
    setLoading(true);
    axios
      .put(`https://3000-yuvraj08-bookstoremern-sjc3k4uq8kx.ws-us114.gitpod.io/books/${id}`, data)
      .then(()=>{
        setLoading(false);
