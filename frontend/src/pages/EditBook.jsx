...
const EditBook = () => {
  ...
  useEffect(()=>{
    setLoading(true);
    axios.get(`https://3000-yuvraj08-bookstoremern-c4enzoxqdc3.ws-us115.gitpod.io/books/${id}`)
    .then((response) => {
  ...
  const handleEditBook = () => {
    ...
    setLoading(true);
    axios
      .put(`https://3000-yuvraj08-bookstoremern-c4enzoxqdc3.ws-us115.gitpod.io/books/${id}`, data)
      .then(()=>{
        setLoading(false);
